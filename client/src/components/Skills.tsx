    ...
    <div>
      ...
      <div className="skillscont">
        ...
        <div className="skill">
          ...
          <p>Enthusiastic about UI/UX <br/>with a background spanning over 3 years in <br/>HTML, CSS, JS, React, and React Native frameworks</p>
        </div>
        <div className="skill">
          ...
          <p>Skilled in developing RESTful APIs <br/>using Node.js and Express.js, <br/>as well as SQL and NoSQL databases</p>
        </div>
      </div>
